  ...
  Loader.prototype._loadElementSource = function (params) {
      return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
              switch (_a.label) {
                  case 0:
                      if (!(params && params.type === 'image')) return [3 /*break*/, 2];
                      return [4 /*yield*/, loadImage(params.source)];
                  case 1:
                      image = _a.sent();
                      return [2 /*return*/, image];
                  case 2:
                      if (!(params && params.type === 'svg')) return [3 /*break*/, 4];
                      return [4 /*yield*/, loadSVG(params.source, {
...
var Core = /** @class */ (function () {
  ...
  Core.prototype.draw = function () {
      ...
      this[_helper].updateConfig(this[_data], {
          ...
          canScroll: this[_opts$3].canScroll === true,
...
var IDraw = /** @class */ (function (_super) {
  ...
  IDraw.prototype._createOpts = function (opts) {
      ...
      return __assign$2(__assign$2({}, defaultOpts), opts);
  };
  return IDraw;
}(Core));
