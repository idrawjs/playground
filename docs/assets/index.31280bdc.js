...
<html>
  <head>
    ...
    <script src="./lib/idraw/\${idrawVersion}/index.global.js"><\/script>
...
</html>`;const Ye="26542214e414f086d44d020bbb";var h={hash:Ye};const qe={codemirror:"^5.62.0",idraw:"0.2.0-alpha.13",vue:"^3.0.5"};function Xe(t){return new URLSearchParams(window.location.search).get(t)}function C(t){return new Promise((e,n)=>{fetch(t).then(s=>{if(s.status===200)return s.text().then(a=>{e(a)}).catch(n);n(s)}).catch(n)})}let $="./../../public";$="./";async function Qe(t){const e=[],n=an(t);if(n===null)return[];try{const s=await C(`${$}/demo/${t}/index.js`);e.push({name:"index.js",fileName:"index.js",code:se(s),type:"js"})}catch(s){console.log(s)}try{if(!(Array.isArray(n.exclude)&&n.exclude.includes("data.js"))){const s=await C(`${$}/demo/${t}/data.js?v=${(h==null?void 0:h.hash)||""}`);e.push({name:"data.js",fileName:"data.js",code:se(s),type:"js"})}}catch(s){console.log(s)}try{const s=await C(`${$}/demo/${t}/index.html?v=${(h==null?void 0:h.hash)||""}`);e.push({name:"html",fileName:"index.html",code:s,type:"html"})}catch(s){console.log(s)}try{let s=await C(`${$}/demo/${t}/index.css?v=${(h==null?void 0:h.hash)||""}`);e.push({name:"css",fileName:"index.css",code:s,type:"css"})}catch(s){console.log(s)}try{const s=await C(`${$}/demo/${t}/import-map.json?v=${(h==null?void 0:h.hash)||""}`);e.push({name:"import-map",fileName:"import-map.json",code:s,type:"json"})}catch(s){console.log(s)}return e}function se(t){const e=/\'\/node_modules\/\.vite\/([\w]+)\.js\?v=[0-9a-zA_Z]{1,}\'/;let n=t.replace(e,a=>{let o="''";const r=e==null?void 0:e.exec(a);return r&&r[1]&&(o=`'${r[1]}'`),o});const s=/\'\/public\/demo\/[0-9a-zA-Z\-\_]{1,}\/([0-9a-zA-Z\-\_]+)\.(js\?t=[0-9]{1,}|js)\'/;return n=n.replace(s,a=>{let o="'./'";const r=s==null?void 0:s.exec(a);return r&&r[1]&&(o=`'./${r[1]}'`),o}),n}function en(t){const e={html:"",css:"",js:"",datajs:"",importmap:"{}"};for(let n=0;n<t.length;n++)t[n].fileName==="index.html"?e.html=t[n].code:t[n].fileName==="index.css"?e.css=t[n].code:t[n].fileName==="index.js"?e.js=t[n].code:t[n].fileName==="data.js"?e.datajs=t[n].code:t[n].fileName==="import-map.json"&&(e.importmap=t[n].code);return e}function nn(t){return Ke.replace(/\$\{idrawVersion\}/ig,qe.idraw.replace(/(\^|\~)/ig,"")).replace(/<!--__INJECT_STYLE__-->/,`<style>${t.css}</style>`).replace(/<!--__INJECT_IMPORTMAP__-->/,`<script type="importmap">${t.importmap}<\/script>`).replace(/<!--__INJECT_HTML__-->/,t.html.replace(/<script[\s\S]*?<\/script>/ig,"")).replace(/<!--__INJECT_JS__-->/,`<script type="module">${tn(t)}<\/script>`)}function tn(t){const e=/import[\s]{1,}([a-zA-Z\_]+)[\s]{1,}from[\s]{1,}\'\.\/data\'/;let n=t.js;n=n.replace(e,a=>{const o=e==null?void 0:e.exec(a);let r=a;if(o&&o[1]){const g=`${o[1]}`,f=/export[\s]{1,}default[\s]{1,}\{/;t.datajs&&f.test(`${t.datajs}`)&&(r=`const ${g} = ${t.datajs.replace(f,"{")}`)}return r});const s=/import[\s]{1,}([a-zA-Z\_]+)[\s]{1,}from[\s]{1,}\'idraw\'/;return n=n.replace(s,a=>{const o=s==null?void 0:s.exec(a);let r=a;return o&&o[1]&&(r=`const ${`${o[1]}`} = window.iDraw`),r}),n}function sn(t){for(let e=0;e<P.length;e++){const n=P[e].list;for(let s=0;s<n.length;s++)if((n[s]||{}).key===t)return!0}return!1}function an(t){for(let e=0;e<P.length;e++){const n=P[e].list;for(let s=0;s<n.length;s++){const a=n[s]||{};if(a.key===t)return a}}return null}const ae=y({setup(t){const e=w(),n=w(),s=w();let a,o;z(r),de(()=>{o.destroy()}),X(()=>{var f,l,_,v,j;return[(f=i==null?void 0:i.files[0])==null?void 0:f.code,(l=i==null?void 0:i.files[1])==null?void 0:l.code,(_=i==null?void 0:i.files[2])==null?void 0:_.code,(v=i==null?void 0:i.files[3])==null?void 0:v.code,(j=i==null?void 0:i.files[4])==null?void 0:j.code]},()=>{r()});function r(){a&&(o.destroy(),e.value.removeChild(a));const f=en(i.files);a=document.createElement("iframe"),a.setAttribute("sandbox",["allow-forms","allow-modals","allow-pointer-lock","allow-popups","allow-same-origin","allow-scripts","allow-top-navigation-by-user-activation"].join(" "));const l=nn(f);a.srcdoc=l,e.value.appendChild(a),o=g(a)}function g(f){return new Ge(f,{on_fetch_progress:l=>{},on_error:l=>{const _=l.value instanceof Error?l.value.message:l.value;_.includes("Failed to resolve module specifier")||_.includes("Error resolving module specifier")?n.value=_.replace(/\. Relative references must.*$/,"")+`.
Tip: add an "import-map.json" file to specify import paths for dependencies.`:n.value=l.value},on_unhandled_rejection:l=>{let _=l.value;typeof _=="string"&&(_={message:_}),n.value="Uncaught (in promise): "+_.message},on_console:l=>{l.duplicate||(l.level==="error"?l.args[0]instanceof Error?n.value=l.args[0].message:n.value=l.args[0]:l.level==="warn"&&l.args[0].toString().includes("[Vue warn]")&&(s.value=l.args.join("").replace(/\[Vue warn\]:/,"").trim()))},on_console_group:l=>{},on_console_group_end:()=>{},on_console_group_collapsed:l=>{}})}return(f,l)=>(u(),m(k,null,[p(d).demoStatus!=="LOADED"?(u(),I(ee,{key:0})):N("",!0),c("div",{class:x({"preview-container":p(d).demoStatus==="LOADED","preview-hide":p(d).demoStatus!=="LOADED"}),ref:(_,v)=>{v.container=_,e.value=_}},null,2)],64))}});const on={class:"sider-container"},rn={class:"sider-menu"},ln={class:"sider-menu-title"},cn={class:"sider-menu-list"},dn=["href"],un=y({setup(t){function e(n){const s=Object.keys(d.urlParams),a=[];return s.forEach(o=>{o==="demo"?a.push(`demo=${n}`):a.push(`${o}=${d.urlParams[o]||""}`)}),`?${a.join("&")}`}return(n,s)=>(u(),m("div",on,[(u(!0),m(k,null,B(p(P),a=>(u(),m("div",rn,[c("div",ln,L(a.name),1),c("div",cn,[(u(!0),m(k,null,B(a.list,o=>(u(),m("a",{class:x(["sider-menu-item",{active:o.key===p(d).urlParams.demo}]),href:e(o.key)},[c("span",null,L(o.name),1)],10,dn))),256))])]))),256))]))}});var pn=S(un,[["__scopeId","data-v-702d1014"]]);const mn=y({setup(t){async function e(){const n=Xe("demo")||"basic";try{if(sn(n)){const s=await Qe(n);Oe(s),s.length>0?F("LOADED"):F("NOT_FINISHED")}else F("NOT_FOUND")}catch(s){console.log(s)}}return e(),(n,s)=>(u(),m(k,null,[p(d).layout.showHeader?(u(),I(be,{key:0})):N("",!0),c("div",{class:x(["container",{"no-header":!p(d).layout.showHeader}])},[p(d).layout.showSider?(u(),I(V,{key:0,defaultSplit:15},{left:E(()=>[b(pn)]),right:E(()=>[b(V,{defaultSplit:p(d).layout.defaultEditorSplit},{left:E(()=>[b(te)]),right:E(()=>[b(ae)]),_:1},8,["defaultSplit"])]),_:1})):(u(),I(V,{key:1,defaultSplit:p(d).layout.defaultEditorSplit},{left:E(()=>[b(te)]),right:E(()=>[b(ae)]),_:1},8,["defaultSplit"]))],2)],64))}});ue(mn).mount("#app");
