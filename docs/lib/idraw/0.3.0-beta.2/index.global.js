var iDraw = function() {
  ...
  class Scroller {
    ...
    _getOpts(opts) {
      ...
      if (!(((_a2 = options === null || options === void 0 ? void 0 : options.scrollConfig) === null || _a2 === void 0 ? void 0 : _a2.width) > 0)) {
  ...
  const _opts$5 = Symbol("_opts");
  const _ctx$2 = Symbol("_ctx");
  class Screen {
    constructor(ctx, opts) {
      this[_opts$5] = opts;
      this[_ctx$2] = ctx;
    ...
    resetSize(opts) {
      this[_opts$5] = Object.assign(Object.assign({}, this[_opts$5]), opts);
    }
    calcScreen() {
      const scaleRatio = this[_ctx$2].getTransform().scale;
      const { width, height, contextWidth, contextHeight, devicePixelRatio: pxRatio } = this[_opts$5];
      ...
      if (contextWidth * scaleRatio >= width && this[_ctx$2].getTransform().scrollX > 0) {
        this[_ctx$2].setTransform({
          scrollX: 0
        });
        canScrollXPrev = false;
      }
      if (contextHeight * scaleRatio >= height && this[_ctx$2].getTransform().scrollY > 0) {
        this[_ctx$2].setTransform({
          scrollY: 0
        });
        canScrollYPrev = false;
      }
      const { scrollX: _scrollX, scrollY: _scrollY } = this[_ctx$2].getTransform();
      ...
      const { scrollX, scrollY } = this[_ctx$2].getTransform();
      const size = {
      ...
      return {
        ...
        position,
        deviceSize,
        width: this[_opts$5].width,
        height: this[_opts$5].height,
        devicePixelRatio: this[_opts$5].devicePixelRatio,
        canScrollYPrev,
        canScrollYNext,
        canScrollXPrev,
        canScrollXNext
  ...
  const _initEvent$1 = Symbol("_initEvent");
  ...
  class Board {
    constructor(mount, opts) {
      ...
      this[_opts$4] = this[_parsePrivateOptions](opts);
      ...
      this[_ctx$1] = new Context(originCtx2d, this[_opts$4]);
      this[_helperCtx] = new Context(helperCtx2d, this[_opts$4]);
      this[_screen] = new Screen(this[_ctx$1], this[_opts$4]);
      this[_watcher] = new ScreenWatcher(this[_displayCanvas], this[_ctx$1]);
    ...
    scale(scaleRatio) {
      if (scaleRatio > 0) {
        this[_ctx$1].setTransform({ scale: scaleRatio });
    ...
    scrollX(x2) {
      ...
      if (x2 >= 0 || x2 < 0) {
        this[_ctx$1].setTransform({ scrollX: x2 });
    ...
    scrollY(y2) {
      ...
      if (y2 >= 0 || y2 < 0) {
        this[_ctx$1].setTransform({ scrollY: y2 });
    ...
    getTransform() {
      return this[_ctx$1].getTransform();
    }
    draw() {
      this.clear();
      ...
      if (this[_opts$4].canScroll === true) {
    ...
    resetSize(opts) {
      this[_opts$4] = Object.assign(Object.assign({}, this[_opts$4]), opts);
      this[_resetContext]();
      this[_ctx$1].resetSize(opts);
    ...
    [_resetContext]() {
      const { width, height, contextWidth, contextHeight, devicePixelRatio } = this[_opts$4];
        ...
        for (let i = loadUUIDList.length; i < maxParallelNum; i++) {
          ...
          this._loadElementSource(this._currentLoadData[uuid]).then((image) => {
            ...
            this._event.trigger("load", {
              uuid: (_a2 = this._storageLoadData[uuid]) === null || _a2 === void 0 ? void 0 : _a2.uuid,
              ...
              element: (_b2 = this._storageLoadData[uuid]) === null || _b2 === void 0 ? void 0 : _b2.element
            });
          }).catch((err) => {
            ...
            if (this._currentLoadData[uuid]) {
              this._storageLoadData[uuid] = {
                uuid,
                type: (_a2 = this._currentLoadData[uuid]) === null || _a2 === void 0 ? void 0 : _a2.type,
                status: "fail",
                content: null,
                error: err,
                source: (_b2 = this._currentLoadData[uuid]) === null || _b2 === void 0 ? void 0 : _b2.source,
                elemW: (_c2 = this._currentLoadData[uuid]) === null || _c2 === void 0 ? void 0 : _c2.elemW,
  ...
  class Renderer extends RendererEvent {
    ...
    render(target, originData, opts) {
      ...
      if (!this[_ctx]) {
        if (this[_opts$3] && Object.prototype.toString.call(target) === "[object HTMLCanvasElement]") {
          const { width, height, contextWidth, contextHeight, devicePixelRatio } = this[_opts$3];
          const canvas = target;
    ...
    [(_a$2 = _queue, _b$2 = _ctx, _c$1 = _status, _freeze)]() {
  ...
  function calcuScaleElemPosition(elem, moveX, moveY, direction, scale) {
    var _a2, _b2, _c2, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
    const p = { x: elem.x, y: elem.y, w: elem.w, h: elem.h };
    elem.angle;
    if (((_a2 = elem.operation) === null || _a2 === void 0 ? void 0 : _a2.limitRatio) === true) {
      ...
      case "top": {
        if (elem.angle === 0 || Math.abs(elem.angle) < limitQbliqueAngle$1) {
          if (p.h - moveY > 0) {
            p.y += moveY;
            p.h -= moveY;
            if (((_b2 = elem.operation) === null || _b2 === void 0 ? void 0 : _b2.limitRatio) === true) {
          ...
          if (p.h + moveDist > 0) {
            if (((_c2 = elem.operation) === null || _c2 === void 0 ? void 0 : _c2.limitRatio) === true) {
  ...
  class Helper {
    ...
    isPointInElementWrapperController(p, data) {
      var _a2, _b2;
      const ctx = this._ctx;
      const uuid = ((_b2 = (_a2 = this._helperConfig) === null || _a2 === void 0 ? void 0 : _a2.selectedElementWrapper) === null || _b2 === void 0 ? void 0 : _b2.uuid) || null;
    ...
    isPointInElementList(p, data) {
      ...
      let idx = -1;
      let uuid = null;
      const wrapperList = ((_a2 = this._helperConfig) === null || _a2 === void 0 ? void 0 : _a2.selectedElementListWrappers) || [];
    ...
    _createSelectedElementWrapper(elem, opts) {
      ...
      const bw = ((_a2 = elem.desc) === null || _a2 === void 0 ? void 0 : _a2.borderWidth) || 0;
      ...
      const wrapper = {
        ...
        controllers: {
          topLeft: {
            ...
            invisible: hideObliqueDirection || ((_c2 = elem === null || elem === void 0 ? void 0 : elem.operation) === null || _c2 === void 0 ? void 0 : _c2.disableScale) === true
          },
          top: {
            x: elem.x + elem.w / 2,
            y: elem.y - controllerOffset - bw,
  ...
  const _board$1 = Symbol("_displayCtx");
  ...
  class Mapper {
    constructor(opts) {
      this[_opts$2] = opts;
      this[_board$1] = this[_opts$2].board;
      this[_element$1] = this[_opts$2].element;
      this[_helper] = this[_opts$2].helper;
    }
    isEffectivePoint(p) {
      const scrollLineWidth = this[_board$1].getScrollLineWidth();
      const screenInfo = this[_board$1].getScreenInfo();
    ...
    judgePointCursor(p, data) {
      ...
      if (uuid && direction) {
        ...
        const [index, uuid2] = this[_element$1].isPointInElement(p, data);
        if (index >= 0) {
          cursor = "move";
        }
        if (uuid2) {
  ...
  const _tempData$1 = Symbol("_tempData");
  ...
  function getSelectedElements(core) {
    ...
    list.forEach((uuid2) => {
      ...
      if (index !== null && index >= 0) {
        const elem = (_a2 = core[_data]) === null || _a2 === void 0 ? void 0 : _a2.elements[index];
        if (elem)
          elems.push(elem);
      }
    });
  ...
  class Engine {
    ...
    _handleDoubleClick(point) {
      ...
      if (index >= 0 && uuid) {
        const elem = deepClone((_a2 = data.elements) === null || _a2 === void 0 ? void 0 : _a2[index]);
        if (((_b2 = elem === null || elem === void 0 ? void 0 : elem.operation) === null || _b2 === void 0 ? void 0 : _b2.invisible) !== true) {
          coreEvent.trigger("screenDoubleClickElement", {
            index,
            uuid,
            element: deepClone((_c2 = data.elements) === null || _c2 === void 0 ? void 0 : _c2[index])
          });
        }
      }
      drawFeekback();
    ...
    _handleClick(point) {
      ...
      if (index >= 0 && uuid) {
        coreEvent.trigger("screenClickElement", {
          index,
          uuid,
          element: deepClone((_a2 = data.elements) === null || _a2 === void 0 ? void 0 : _a2[index])
        });
      }
      drawFeekback();
    }
  ...
  class Core {
    ...
    [(_a$1 = _coreEvent, _b$1 = _tempData$1, _draw)](opts) {
  ...
  class iDraw2 extends Core {
    ...
    [(_a = _hasInited, _b = _tempData, _c = _keyboardWatcher, _initEvent)]() {
